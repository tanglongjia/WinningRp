...
!function (a) {
    ...
    m.DEFAULTS = {
    ...
    }, m.LOCALES = [], m.LOCALES["en-US"] = m.LOCALES.en = {
    ...
    }, a.extend(m.DEFAULTS, m.LOCALES["en-US"]), m.COLUMN_DEFAULTS = {
        radio: !1,
        checkbox: !1,
        checkboxEnabled: !0,
        field: void 0,
    ...
    }, m.prototype.initLocale = function () {
    ...
    }, m.prototype.initTable = function () {
        var b = this, c = [], d = [];
        this.$header = this.$el.find("thead"), this.$header.length || (this.$header = a("<thead></thead>").appendTo(this.$el)), this.$header.find("tr").each(function () {
            ...
            a.each(d, function (d, e) {
                e = a.extend({}, m.COLUMN_DEFAULTS, e), "undefined" != typeof e.fieldIndex && (b.columns[e.fieldIndex] = e), b.options.columns[c][d] = e
            })
    ...
    }, m.prototype.initHeader = function () {
        var b = this, d = {}, e = [];
        this.header = {
            fields: [],
            styles: [],
    ...
    }, m.prototype.initToolbar = function () {
        ...
        }), "" !== this.options.searchText && (d.val(this.options.searchText), f.onSearch({currentTarget: d})))
    }, m.prototype.onSearch = function (b) {
    ...
    }, m.prototype.initSearch = function () {
        var b = this;
    ...
    }, m.prototype.initPagination = function () {
    ...
    }, m.prototype.updatePagination = function (b) {
    ...
    }, m.prototype.onPageListChange = function (b) {
        ...
        for (var k = this.pageFrom - 1; k < this.pageTo; k++) {
            var l, m = i[k], n = {}, o = [], p = "", q = {}, r = [];
            if (n = h(this.options, this.options.rowStyle, [m, k], n), n && n.css)for (l in n.css)o.push(l + ": " + n.css[l]);
            if (q = h(this.options, this.options.rowAttributes, [m, k], q))for (l in q)r.push(c('%s="%s"', l, j(q[l])));
            m._data && !a.isEmptyObject(m._data) && a.each(m._data, function (a, b) {
                "index" !== a && (p += c(' data-%s="%s"', a, b))
            }), g.push("<tr", c(" %s", r.join(" ")), c(' id="%s"', a.isArray(m) ? void 0 : m._id), c(' class="%s"', n.classes || (a.isArray(m) ? void 0 : m._class)), c(' data-index="%s"', k), c(' data-uniqueid="%s"', m[this.options.uniqueId]), c("%s", p), ">"), this.options.cardView && g.push(c('<td colspan="%s">', this.header.fields.length)), !this.options.cardView && this.options.detailView && g.push("<td>", '<a class="detail-icon" href="javascript:">', c('<i class="%s %s"></i>', this.options.iconsPrefix, this.options.icons.detailOpen), "</a>", "</td>"), a.each(this.header.fields, function (b, i) {
                var j = "", l = m[i], p = "", q = {}, r = "", s = f.header.classes[b], t = "", u = "", v = "", w = f.columns[e(f.columns, i)];
                if (w.visible) {
                    if (n = c('style="%s"', o.concat(f.header.styles[b]).join("; ")), l = h(w, f.header.formatters[b], [l, m, k], l), m["_" + i + "_id"] && (r = c(' id="%s"', m["_" + i + "_id"])), m["_" + i + "_class"] && (s = c(' class="%s"', m["_" + i + "_class"])), m["_" + i + "_rowspan"] && (u = c(' rowspan="%s"', m["_" + i + "_rowspan"])), m["_" + i + "_title"] && (v = c(' title="%s"', m["_" + i + "_title"])), q = h(f.header, f.header.cellStyles[b], [l, m, k], q), q.classes && (s = c(' class="%s"', q.classes)), q.css) {
                        var x = [];
                        for (var y in q.css)x.push(y + ": " + q.css[y]);
                        n = c('style="%s"', x.concat(f.header.styles[b]).join("; "))
                    }
                    m["_" + i + "_data"] && !a.isEmptyObject(m["_" + i + "_data"]) && a.each(m["_" + i + "_data"], function (a, b) {
                        "index" !== a && (t += c(' data-%s="%s"', a, b))
                    }), w.checkbox || w.radio ? (p = w.checkbox ? "checkbox" : p, p = w.radio ? "radio" : p, j = [f.options.cardView ? '<div class="card-view">' : '<td class="bs-checkbox">', "<input" + c(' data-index="%s"', k) + c(' name="%s"', f.options.selectItemName) + c(' type="%s"', p) + c(' value="%s"', m[f.options.idField]) + c(' checked="%s"', l === !0 || l && l.checked ? "checked" : void 0) + c(' disabled="%s"', !w.checkboxEnabled || l && l.disabled ? "disabled" : void 0) + " />", f.options.cardView ? "</div>" : "</td>"].join(""), m[f.header.stateField] = l === !0 || l && l.checked) : (l = "undefined" == typeof l || null === l ? f.options.undefinedText : l, j = f.options.cardView ? ['<div class="card-view">', f.options.showHeader ? c('<span class="title" %s>%s</span>', n, d(f.columns, "field", "title", i)) : "", c('<span class="value">%s</span>', l), "</div>"].join("") : [c("<td%s %s %s %s %s %s>", r, s, n, t, u, v), l, "</td>"].join(""), f.options.cardView && f.options.smartDisplay && "" === l && (j = "")), g.push(j)
                }
        ...
        g.length || g.push('<tr class="no-records-found">', c('<td colspan="%s">%s</td>', this.$header.find("th").length, this.options.formatNoMatches()), "</tr>"), this.$body.html(g.join("")), b || this.scrollTo(0), this.$body.find("> tr[data-index] > td").off("click dblclick").on("click dblclick", function (b) {
            var d = a(this), g = d.parent(), h = f.data[g.data("index")], i = d[0].cellIndex, j = f.header.fields[f.options.detailView && !f.options.cardView ? i - 1 : i], k = f.columns[e(f.columns, j)], l = h[j];
            if (!d.find(".detail-icon").length && (f.trigger("click" === b.type ? "click-cell" : "dbl-click-cell", j, l, h, d), f.trigger("click" === b.type ? "click-row" : "dbl-click-row", h, g), "click" === b.type && f.options.clickToSelect && k.clickToSelect)) {
                var m = g.find(c('[name="%s"]', f.options.selectItemName));
                m.length && m[0].click()
            }
            ...
            var c = a(this).prop("checked"), d = f.data[a(this).data("index")];
            d[f.header.stateField] = c, f.options.singleSelect && (f.$selectItem.not(this).each(function () {
                f.data[a(this).data("index")][f.header.stateField] = !1
            }), f.$selectItem.filter(":checked").not(this).prop("checked", !1)), f.updateSelected(), f.trigger(c ? "check" : "uncheck", d)
    ...
    }, m.prototype.initServer = function (b, c) {
        var d, e = this, f = {}, g = {
    ...
    }, m.prototype.updateSelected = function () {
    ...
    }, m.prototype.resetRows = function () {
        var b = this;
    ...
    }, m.prototype.trigger = function (b) {
        var c = Array.prototype.slice.call(arguments, 1);
        b += ".bs.table", this.options[m.EVENTS[b]].apply(this.options, c), this.$el.trigger(a.Event(b), c), this.options.onAll(b, c), this.$el.trigger(a.Event("all.bs.table"), [b, c])
    }, m.prototype.resetHeader = function () {
        clearTimeout(this.timeoutId_), this.timeoutId_ = setTimeout(a.proxy(this.fitHeader, this), this.$el.is(":hidden") ? 100 : 0)
    }, m.prototype.fitHeader = function () {
        var b, d, e = this;
        if (e.$el.is(":hidden"))return void(e.timeoutId_ = setTimeout(a.proxy(e.fitHeader, e), 100));
        b = this.$tableBody.get(0), d = b.scrollWidth > b.clientWidth && b.scrollHeight > b.clientHeight + this.$header.outerHeight() ? g() : 0, this.$el.css("margin-top", -this.$header.outerHeight()), this.$header_ = this.$header.clone(!0, !0), this.$selectAll_ = this.$header_.find('[name="btSelectAll"]'), this.$tableHeader.css({"margin-right": d}).find("table").css("width", this.$el.outerWidth()).html("").attr("class", this.$el.attr("class")).append(this.$header_), this.$header.find("th[data-field]").each(function () {
            e.$header_.find(c('th[data-field="%s"]', a(this).data("field"))).data(a(this).data())
        });
        var f = this.getVisibleFields();
        this.$body.find("tr:first-child:not(.no-records-found) > *").each(function (b) {
            var d = a(this), g = b;
            e.options.detailView && !e.options.cardView && (0 === b && e.$header_.find("th.detail").find(".fht-cell").width(d.innerWidth()), g = b - 1), e.$header_.find(c('th[data-field="%s"]', f[g])).find(".fht-cell").width(d.innerWidth())
        }), this.$tableBody.off("scroll").on("scroll", function () {
            e.$tableHeader.scrollLeft(a(this).scrollLeft()), e.options.showFooter && !e.options.cardView && e.$tableFooter.scrollLeft(a(this).scrollLeft())
        }), e.trigger("post-header")
    }, m.prototype.resetFooter = function () {
    ...
    }, m.prototype.fitFooter = function () {
        var b, c, d;
    ...
    }, m.prototype.toggleColumn = function (a, b, d) {
    ...
    }, m.prototype.toggleRow = function (b, d, e) {
        -1 !== b && a(this.$body[0]).children().filter(c(d ? '[data-uniqueid="%s"]' : '[data-index="%s"]', b))[e ? "show" : "hide"]()
    }, m.prototype.getVisibleFields = function () {
        var b = this, c = [];
        return a.each(this.header.fields, function (a, d) {
            var f = b.columns[e(b.columns, d)];
            f.visible && c.push(d)
        }), c
    }, m.prototype.resetView = function (a) {
        var b = 0;
    ...
    }, m.prototype.getData = function (b) {
        ...
        var c = !1;
        //"client" === this.options.sidePagination ? (this.options.totalRows = b.total, c = b.fixedScroll, b = b.rows) :
         a.isArray(b) || (c = b.fixedScroll, b = b.data), this.initData(b), this.initSearch(), this.initPagination(), this.initBody(c)
    ...
    }, m.prototype.getRowByUniqueId = function (a) {
        ...
        return f
    }, m.prototype.removeByUniqueId = function (a) {
    ...
    }, m.prototype.insertRow = function (a) {
    ...
    }, m.prototype.updateCell = function (a) {
        ...
        return this.options
    }, m.prototype.getSelections = function () {
        var b = this;
        return a.grep(this.data, function (a) {
            return a[b.header.stateField]
        })
    }, m.prototype.getAllSelections = function () {
        var b = this;
        return a.grep(this.options.data, function (a) {
            return a[b.header.stateField]
        })
    }, m.prototype.checkAll = function () {
        this.checkAll_(!0)
    }, m.prototype.uncheckAll = function () {
        this.checkAll_(!1)
    }, m.prototype.checkAll_ = function (a) {
        var b;
    ...
    }, m.prototype.check = function (a) {
        this.check_(!0, a)
    }, m.prototype.uncheck = function (a) {
        this.check_(!1, a)
    }, m.prototype.check_ = function (a, b) {
    ...
    }, m.prototype.checkBy = function (a) {
        this.checkBy_(!0, a)
    }, m.prototype.uncheckBy = function (a) {
        this.checkBy_(!1, a)
    }, m.prototype.checkBy_ = function (b, d) {
        if (d.hasOwnProperty("field") && d.hasOwnProperty("values")) {
            var e = this, f = [];
            a.each(this.options.data, function (g, h) {
                return h.hasOwnProperty(d.field) ? void(-1 !== a.inArray(h[d.field], d.values) && (e.$selectItem.filter(c('[data-index="%s"]', g)).prop("checked", b), h[e.header.stateField] = b, f.push(h), e.trigger(b ? "check" : "uncheck", h))) : !1
    ...
    }, m.prototype.showLoading = function () {
        this.$tableLoading.show()
    }, m.prototype.hideLoading = function () {
        this.$tableLoading.hide()
    }, m.prototype.togglePagination = function () {
    ...
    }, m.prototype.getScrollPosition = function () {
        return this.scrollTo()
    }, m.prototype.selectPage = function (a) {
        a > 0 && a <= this.options.totalPages && (this.options.pageNumber = a, this.updatePagination())
    }, m.prototype.prevPage = function () {
    ...
    a.fn.bootstrapTable = function (b) {
        ...
        return this.each(function () {
            var e = a(this), f = e.data("bootstrap.table"), g = a.extend({}, m.DEFAULTS, e.data(), "object" == typeof b && b);
            if ("string" == typeof b) {
                if (a.inArray(b, n) < 0)throw new Error("Unknown method: " + b);
                if (!f)return;
                c = f[b].apply(f, d), "destroy" === b && e.removeData("bootstrap.table")
            }
            f || e.data("bootstrap.table", f = new m(this, g))
        }), "undefined" == typeof c ? this : c
    }, a.fn.bootstrapTable.Constructor = m, a.fn.bootstrapTable.defaults = m.DEFAULTS, a.fn.bootstrapTable.columnDefaults = m.COLUMN_DEFAULTS, a.fn.bootstrapTable.locales = m.LOCALES, a.fn.bootstrapTable.methods = n, a(function () {

...
<head>
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="<%=basePath%>assertsRp/css/AdminLTE.min.css">
    ...
    <script src="<%=basePath%>/assertsRp/js/json2.js"></script>
    <script src="<%=basePath%>assertsRp/js/toastr.min.js"></script>
    <!-- tooltip插件-->
...
<div class="panel-body" style="font-size: 13px; text-align: left; padding:0px; background-color: #ECEFF4;">
	<div class="box win-search-box">
       <div class="box-header" style="background-color: white;">
           <div class="box-title">功能配置</div>
           <div class="box-tools">
	  		  <button type="button" class="btn btn-default btn-sm" style="float: right; color: white;"  onclick="saveBgpz()" >保存</button>
           </div>
        </div>
	</div>
            ...
            <div class="box-body" >
	            <form class="form-inline" onSubmit="return false">
		            <div class="row" >
		            	<div class="col-md-3">
	        				 表格代码: 
						    <input class="form-control" id="bgdm" style="min-width: 170px;" readonly="true"/>
				        </div>
	        			<div class="col-md-3">
	        				 表格名称: 
						    <input class="form-control" id="bgmc" style="min-width: 170px;" />
				        </div>
				        <div class="col-md-3">
	        				 类&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别: 
				    ...
				    <div class="row" style="padding-top:5px">
	        			...
	        			<div class="col-md-3">
	        				 填报表名称:
						    <input class="form-control" id="tbbmc" style="min-width: 170px;" onchange="getCsjyl(this.value)"/>
				        </div>
				    </div>
				</form>
			</div>
			       				...
			       				<div class="col-md-6" style="border-right: 1px solid #EEEEEE;">
			       					<div class="row" style="min-height: 150px;">
			        					<div class="col-md-12" >
					        				  ...
					        				  <button onclick="tr_add('1')" class="btn btn-default btn-sm" disabled="disabled"  id="cxtj_bc" style="float: right; color: white;">保存</button>
					        				  <button onclick="tr_add('2')" class="btn btn-default btn-sm" style="float: right; color: white;">添加</button> <br/>
					        				  <div class="row">
		        				...
		        				<div class="col-md-6" style="border-right: 1px solid #EEEEEE;">
		        					<div class="row" style="min-height: 400px; ">
				        				  <div class="col-md-12">
					        				  ...
					        				  <button onclick="show_tr_add('1')" class="btn btn-default btn-sm" disabled="disabled"  id="xsjg_bc"  style="float: right; color: white;">保存</button>
					        				  <button onclick="show_tr_add('2')" class="btn btn-default btn-sm" style="float: right; color: white;">添加</button><br/><br/>
					        				  <div class="row">
	...
	function show_tr_add(code){
		...
		*/
		...
		var table_tr="";
			...
			table_tr+="		<td>";
			table_tr+="			<button class=\"btn btn-default btn-xs\"  style=\"color: white;\" ";
			table_tr+="				onclick=\"show_tr_edit('"+trid1+"')\"> 修改";
			table_tr+="			</button>";
			table_tr+="			<button class=\"btn btn-default btn-xs\"  style=\"color: white;\" ";
			table_tr+="				onclick=\"show_tr_del('"+trid1+"')\">删除";
			table_tr+="			</button>";
			table_tr+="		</td>";
			table_tr+="</tr>";
		//修改
